...
python ../docs/examples/pytorch/pytorch_cpu_vs_gpu_simple_benchmark.py | tee -a ${FN_PYTORCH_CPU_VS_GPU_SIMPLE_RES}

echo "Saving to file: $FN_PYTORCH_DOT_PRODUCT_FLASH_RES"
python ../docs/examples/pytorch/flash_attention/flash_attention_dot_product_benchmark.py | tee -a ${FN_PYTORCH_DOT_PRODUCT_FLASH_RES}
